...
注意：脚本与插件一样都是运行在服务端的，本地客户端作为房主开房也可以用，但进入别的房间是没有用的。

# 使用说明

## 安装

将以下列出的所需文件复制到 left4dead2/scripts/vscripts 目录下即可完成安装。
...
Plugins 目录下是本系列脚本的一个辅助插件 LinGe VScripts，基于 sourcemod 插件平台，可选安装。
